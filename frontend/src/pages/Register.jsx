    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12 relative overflow-hidden glow-bg">
      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-3xl border border-border shadow-2xl shadow-primary/5 animate-scale-up">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold tracking-tight text-foreground">Get Started</h2>
          <p className="text-sm text-muted-foreground mt-2">
            Create your account to unlock AI analytics
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-11 pr-4 py-2.5 rounded-2xl border border-border bg-card text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all duration-200"
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full flex items-center justify-center space-x-2 bg-primary hover:bg-primary/95 text-primary-foreground py-3 rounded-2xl font-semibold hover:shadow-lg hover:shadow-primary/20 active:scale-[0.99] disabled:opacity-50 transition-all duration-200 focus:outline-none mt-2"
          >
            {isLoading ? (
